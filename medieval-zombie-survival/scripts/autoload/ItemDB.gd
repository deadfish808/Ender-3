...
const ITEMS := {
	...
	# food / consumables
	"berries": {"name": "Berries", "desc": "Wild berries. Eat to restore hunger.", "type": "food", "food": 24, "heal": 2},
	"mushroom": {"name": "Mushroom", "desc": "A forest mushroom. Edible... probably.", "type": "food", "food": 18, "heal": 0},
	...
	"raw_fish": {"name": "Raw Fish", "desc": "Fresh from the lake. Better cooked.", "type": "food", "food": 16, "heal": 0},
...
const RECIPES := [
	...
	{"out": "bandage", "count": 1, "cost": {"fiber": 2}, "station": ""},
